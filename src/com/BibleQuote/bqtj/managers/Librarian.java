 ...
 */
package com.BibleQuote.bqtj.managers;
...
import com.BibleQuote.bqtj.managers.History.IHistoryManager;
import com.BibleQuote.bqtj.managers.History.SimpleHistoryManager;
import com.BibleQuote.bqtj.modules.*;
import com.BibleQuote.bqtj.utils.*;
//import com.BibleQuote.BibleQuoteAndroid.utils.Share.ShareBuilder;
...
public class Librarian {
	 ...
	 */
	public Librarian(CoreContext coreContext) {
		LogTxt.i(TAG, "Create library controllers");
		libCtrl = LibraryController.create(coreContext);
...
//			} catch (OpenModuleException e) {
//				LogTxt.e(TAG, String.format("Error open module %1$s for link %2$s",
//						reference.getModuleID(), reference.getBookID()));
//				continue;
//			} catch (BookNotFoundException e) {
//				LogTxt.e(TAG, String.format("Not found book %1$s in module %2$s",
